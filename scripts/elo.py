...
def update_elo_ratings():
    ...
    """
    matches_df = pd.read_csv("data/battle_votes.csv")
    ...
    ratings_ci_df.to_csv("data/elo_ratings_with_ci.csv", index=False)
...
def plot_elo_confidence_intervals(
    ...
    ratings_ci_df = pd.read_csv("data/elo_ratings_with_ci.csv")
...
if __name__ == "__main__":
    ...
    plt.ylabel("Player")
    plt.tight_layout()
    plt.savefig("plots/expected_scores_matrix.png")
    # plt.show()
    plt.close()
    plot_elo_confidence_intervals(
        ...
        y_label="Elo Rating",
        figsize=(12, 8),
    ).savefig("plots/elo_ratings_with_ci.png")
